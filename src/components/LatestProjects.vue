                ...
                <v-card :color="cardColor">
                    ...
                    <v-expand-transition>
                        <div v-show="card.show">
                            ...
                            <v-card-text>
                                {{ $vuetify.lang.t(card.description) }}
                            </v-card-text>
                        </div>
                    </v-expand-transition>
                </v-card>
    ...
    data: () => ({
        cards: [
            ...
            },
            {
                ...
                description: "$vuetify.descRecipe",
                show: false,
            },
            {
                ...
                description: "$vuetify.descEcommerce",
                show: false,
            },
        ],
        show: false,
